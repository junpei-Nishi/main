...
class NoveltyDetector:
    ...
    def __init__(self, nth_layer=42, nn_name='MobileNet', detector_name='lof', pool=None, pca_n_components=None):
        """
    ...
    def _load_NN_model(self, input_shape=(192, 192, 3)):
        """
    ...
    def fit(self, imgs):
        ...
        feature = self.extracting_model.predict(imgs, batch_size=16, verbose=1)
